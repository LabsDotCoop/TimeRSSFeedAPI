...
<?php 
   ...
   $roun_mayanextended 	= 		MayanLongCountSeconds($now,$zone,$roun_mayan);
...
ob_start(); ?>
<item> 
<title>Mayan Extended Long Count : <?php echo htmlspecialchars($roun_mayan['longcount']['ppo'].'.'.$roun_mayanextended['ppo']); ?></title> 
<description>Mayan Hour Long Count: <?php echo htmlspecialchars($roun_mayanextended['ppo']); ?></description> 
<link>http://en.wikipedia.org/wiki/Mayan_long_count</link> 
<category>Ancient History</category>
<pubDate><?php echo gmdate('D, d M Y H:i:s', time()); ?></pubDate>
